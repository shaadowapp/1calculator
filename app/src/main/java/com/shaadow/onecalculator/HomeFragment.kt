...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Remove btn_settings and btn_hot_apps click listeners since those views are no longer in the fragment
        // val btnSettings = binding.root.findViewById<ImageView>(R.id.btn_settings)
        // btnSettings.setOnClickListener { ... }
        // val btnHotApps = binding.root.findViewById<ImageView>(R.id.btn_hot_apps)
        // btnHotApps.setOnClickListener { ... }
    }
